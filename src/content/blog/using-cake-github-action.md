...
![Workflow with secrets](/blog-images/2018/12/15/workflow-with-secrets.png)
...
![Milestone created event payload](/blog-images/2018/12/15/milestone-created-event-payload.png)

![Milestone created no tweet](/blog-images/2018/12/15/milestone-created-no-tweet.png)

I then went ahead and closed the milestone.  Checking the logs, I then saw the following:

![Milestone closed event payload](/blog-images/2018/12/15/milestone-closed-event-payload.png)

![Milestone closed tweet sent](/blog-images/2018/12/15/milestone-closed-tweet-sent.png)
