...
![Octobox Inbox](/blog-images/2017/03/13/Octobox%20Inbox.png)
...
![Package Center Docker](/blog-images/2017/03/13/Package_Center_Docker.png)
...
![Package Center Git](/blog-images/2017/03/13/Package_Center_Git.png)
...
![Control Panel SSH](/blog-images/2017/03/13/Control_Panel_SSH.png)
...
![GitHub OAuth Application Settings](/blog-images/2017/03/13/GitHub_OAuth_Application.png)
...
![Docker Temporary Containers](/blog-images/2017/03/13/docker_temporary_containers.png)

The end result, once complete, should look like the following:

![Completed Docker Images](/blog-images/2017/03/13/Completed_Docker_Images.png)

![Completed Docker Containers](/blog-images/2017/03/13/Completed_Docker_Containers.png)

## 7. Doh!

Now, after all that waiting around, like me, you might end up with the following error message:

![When things go wrong...](/blog-images/2017/03/13/things_not_looking_good.png)
...
![echo output](/blog-images/2017/03/13/echo_output.png)
...
![Docker Compose Success](/blog-images/2017/03/13/docker_compose_success.png)
...
![It's ALIVE!](/blog-images/2017/03/13/its_alive.png)
