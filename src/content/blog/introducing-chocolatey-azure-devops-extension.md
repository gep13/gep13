...
![Chocolatey Get It Free](/blog-images/2018/11/25/Chocolatey-Get-It-Free.png)
...
![Chocolatey Add New Task](/blog-images/2018/11/25/Chocolatey-Add-New-Task.png)

With that done, drill into the options for the task, and select what command you want to use:

![Chocolatey Task](/blog-images/2018/11/25/Chocolatey-Task.png)
