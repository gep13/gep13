...
![Expression Design Export Menu](/blog-images/2013/5/24/Expression-Design-Export-Menu.png)

On the next window, you will then be able to choose the output format, and also the size of the resulting image:

![Expression Design Export Options](/blog-images/2013/5/24/Expression-Design-Export-Options.png)
