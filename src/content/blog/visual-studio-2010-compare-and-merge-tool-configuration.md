...
- Change the "Current source control plug-in" DropDownList to be "Visual Studio Team Foundation Server"
    ...
    ![Options](/blog-images/2011/3/15/image1.png)

- Select "Visual Studio Team Foundation Server" in the tree under "Source Control"
- Click the "Configure User Tools..." button

    ![Options](/blog-images/2011/3/15/image2.png)

- Click the "Add..." button

    ![Configure User Tools](/blog-images/2011/3/15/image3.png)
...
- Hit "OK"
    ...
    ![Configure Tool](/blog-images/2011/3/15/image4.png)
...
- Hit "OK"
    ...
    ![Configure Tool](/blog-images/2011/3/15/image5.png)
